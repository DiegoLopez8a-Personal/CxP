...
Se encarga específicamente de: **Operaciones de archivo: Mover archivos físicos (Punto H).**
...
2.  **Ejecución de Lógica de Negocio:**
    ...
    *   Mueve archivos PDF/XML a carpetas específicas basadas en el resultado de la agrupación.
