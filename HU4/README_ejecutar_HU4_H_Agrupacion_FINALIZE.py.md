...
Se encarga específicamente de: **Finalizar el proceso de agrupación de documentos.**
...
2.  **Ejecución de Lógica de Negocio:**
    ...
    *   Marca los registros procesados en la etapa de agrupación como finalizados y actualiza su estado en `DocumentsProcessing`.
