# ejecutar_HU4_ABCD_CamposObligatorios.py
...
Se encarga específicamente de: **Validar la existencia y formato de campos obligatorios en los documentos procesados (Puntos A, B, C, D).**
...
2.  **Ejecución de Lógica de Negocio:**
    ...
    *   Verifica que campos clave como NIT, Factura, Fecha, y Valores no estén vacíos y cumplan con el formato esperado.
