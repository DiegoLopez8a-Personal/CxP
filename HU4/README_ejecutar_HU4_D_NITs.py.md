...
Se encarga específicamente de: **Validar específicamente los NITs de los proveedores contra la base de datos maestra.**
...
2.  **Ejecución de Lógica de Negocio:**
    ...
    *   Consulta tablas de proveedores para asegurar que el NIT en la factura corresponda a un proveedor activo y válido.
